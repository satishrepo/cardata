                    ...
                    <div class="login-card card-block auth-body">
                            ...
                            <div class="auth-box">
                                ...
                                <div class="row m-t-25 text-left">
                                    ...
                                    <div class="col-sm-10 col-xs-12 forgot-phone text-right">
                                        <a href="<?php echo base_url(); ?>administrator/forget-password" class="text-right f-w-600 text-inverse"> Forgot Password?</a>
                                    </div>
                                </div>
